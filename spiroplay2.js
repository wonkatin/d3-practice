...
function drawSpiro(doDash) {
	...
	path
	  	...
	  	.transition().duration(spiroParameters["Duration"] * 1000).ease(d3.easeLinear)
...
// document.ready(function() {
	...
	setTimeout(function() {
		...
		changeParameters(96, 56, startRho, 0, 0, steps, 4, thick, "screen", colors[2], background, scale, false);
		drawSpiro(false);
		// for(var i = 1; i <=3; i++) {
